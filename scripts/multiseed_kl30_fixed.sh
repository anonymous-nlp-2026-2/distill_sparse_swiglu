...
echo "=== KL 30% seed=123 Training (lambda_max=5000) ==="
$PYTHON -u src/train.py \
  ...
  --lambda_max 5000 \
  --output_dir checkpoints/kl_30pct_s123 --wandb_run_name kl_30pct_s123

echo "=== KL 30% seed=123 Eval ==="
$PYTHON -u src/benchmark_eval.py --exp_id kl_30pct_s123 \
...
$PYTHON -u src/benchmark_eval.py --exp_id kl_30pct_s456 \
